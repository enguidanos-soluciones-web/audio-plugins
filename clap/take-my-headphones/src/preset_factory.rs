...
// Param indices: 0=Cutoff, 1=XFeed, 2=CalibrationMode, 3=Center, 4=Angle, 5=LRSwap, 6=Solo, 7=Phase
// bs2b canonical presets from https://bs2b.sourceforge.net/
// Center=0.0 dB (neutral), Angle=30°, LRSwap=Off, Solo=Off, Phase=Off
...
pub const PRESETS: &[PresetDef] = &[
    PresetDef {
        name: "Default",
        load_key: "default",
        values: [700.0, 4.5, 0.0, 0.0, 30.0, 0.0, 1.0, 1.0],
    },
    PresetDef {
        name: "Chu Moy",
        load_key: "chu-moy",
        values: [700.0, 6.0, 0.0, 0.0, 30.0, 0.0, 1.0, 1.0],
    },
    PresetDef {
        name: "Jan Meier",
        load_key: "jan-meier",
        values: [650.0, 9.5, 0.0, 0.0, 30.0, 0.0, 1.0, 1.0],
    },
];
