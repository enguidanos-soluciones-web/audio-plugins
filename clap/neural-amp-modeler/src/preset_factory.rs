...
// Param indices: 0=InputGain, 1=OutputGain, 2=Tone, 3=Blend
...
pub const PRESETS: &[PresetDef] = &[
    PresetDef {
        name: "Default",
        load_key: "default",
        //          InputGain  OutputGain  Tone  Blend
    ...
    PresetDef {
        name: "Boosted Input",
        load_key: "boosted-input",
        //          InputGain  OutputGain  Tone  Blend
        values: [6.0, -6.0, 0.5, 1.0],
    },
];
...
static PROVIDER_DESCRIPTOR: clap_preset_discovery_provider_descriptor_t = clap_preset_discovery_provider_descriptor {
    ...
    id: c"com.enguidanosweb.NeuralAmpModeler.presets".as_ptr(),
    name: c"NeuralAmpModeler Presets".as_ptr(),
